...
Use (either Juniper or Pavito) + (either GLPK or Cbc) for MINLP.
"""
...
## Use either solver below:
optimizer = Juniper.Optimizer
# optimizer = Pavito.optimizer

## Use either sub-solver below:
...
@variable(model, xv[1:no_of_class*no_of_edges] >= 0, Int)
